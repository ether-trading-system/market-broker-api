...
config_manager.set("KIS_APP_KEY", "aaa")
config_manager.set("KIS_APP_SECRET", "bbb")
...
async def get_env_info():
    ...
    return {
        ...
        "kis_app_key": config_manager.get("KIS_APP_KEY"),
        "kis_app_secret": config_manager.get("KIS_APP_SECRET")
    }
...
def test_env_info():
    ...
    expected_response = {
        ...
        "kis_app_key": "test_app_key111",
        "kis_app_secret": "test_app_secret123"
    }
